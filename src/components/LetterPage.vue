...
const paragraphsData = [
  ...
  '您的课堂，总是充满温度与智慧。讲到偏序集的上界、下界时，抽象的概念在您口中变得生动起来。您用我们上课的教室作比喻：教室中的天花板及其以上都是我们的上界，而头顶的天花板便是最小上界。“但是，”您话锋一转，“假如班上有位同学站在桌子上，那么他虽然比教室里任何人都高，也同样是最小上界。”这样贴近生活的讲解，让晦涩的定义瞬间清晰。而在讲到图论中“基本道路”与“简单道路”的区别时，您拿逛景点和每天上下学两种路线作比：逛景点不可以重复经过同一个景点，而上下学则不会走重复道路。这些看似随意的类比，却总能让我们在会心一笑中，抓住概念的本质。',
